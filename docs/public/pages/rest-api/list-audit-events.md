...
description: 'Reference for GET /api/v1/admin/audit-events.'
updated: '2026-07-15'
---
...
Reference for GET /api/v1/admin/audit-events.
...
```bash
curl 'http://localhost:8977/api/v1/admin/audit-events' \
...
| --- | --- | --- | --- | --- |
| `limit` | query | No | `string` | Pattern: `^\d+$`. |
