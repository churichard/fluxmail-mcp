---
title: 'List a member''s sessions'
description: 'Reference for GET /api/v1/admin/members/{memberId}/sessions.'
updated: '2026-07-15'
---

<!-- This page is generated from the OpenAPI schema. Run pnpm docs:generate to update it. -->

`GET /api/v1/admin/members/{memberId}/sessions`

Reference for GET /api/v1/admin/members/{memberId}/sessions.
...
```bash
curl 'http://localhost:8977/api/v1/admin/members/memberId_123/sessions' \
