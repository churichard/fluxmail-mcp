---
title: 'Redeem a password reset'
description: 'Reference for POST /api/v1/auth/password-reset.'
updated: '2026-07-15'
---
...
Reference for POST /api/v1/auth/password-reset.
...
```bash
curl 'http://localhost:8977/api/v1/auth/password-reset' \
  -X POST \
