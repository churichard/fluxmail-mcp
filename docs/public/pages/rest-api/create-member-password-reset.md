---
title: 'Issue a member password reset'
description: 'Reference for POST /api/v1/admin/members/{memberId}/password-reset.'
updated: '2026-07-15'
---

<!-- This page is generated from the OpenAPI schema. Run pnpm docs:generate to update it. -->

`POST /api/v1/admin/members/{memberId}/password-reset`

Reference for POST /api/v1/admin/members/{memberId}/password-reset.
...
```bash
curl 'http://localhost:8977/api/v1/admin/members/memberId_123/password-reset' \
  -X POST \
