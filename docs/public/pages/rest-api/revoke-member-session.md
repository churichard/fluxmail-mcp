---
title: 'Revoke a member''s session'
description: 'Reference for DELETE /api/v1/admin/members/{memberId}/sessions/{sessionId}.'
updated: '2026-07-15'
---

<!-- This page is generated from the OpenAPI schema. Run pnpm docs:generate to update it. -->

`DELETE /api/v1/admin/members/{memberId}/sessions/{sessionId}`

Reference for DELETE /api/v1/admin/members/{memberId}/sessions/{sessionId}.
...
```bash
curl 'http://localhost:8977/api/v1/admin/members/memberId_123/sessions/sessionId_123' \
  -X DELETE \
