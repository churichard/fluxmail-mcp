---
title: 'List current member sessions'
description: 'Reference for GET /api/v1/me/sessions.'
updated: '2026-07-15'
---
...
Reference for GET /api/v1/me/sessions.
...
```bash
curl 'http://localhost:8977/api/v1/me/sessions' \
