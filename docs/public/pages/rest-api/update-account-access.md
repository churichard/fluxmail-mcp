---
title: 'Update mailbox ownership and access'
description: 'Reference for PATCH /api/v1/admin/accounts/{accountId}.'
updated: '2026-07-15'
---
...
Reference for PATCH /api/v1/admin/accounts/{accountId}.
