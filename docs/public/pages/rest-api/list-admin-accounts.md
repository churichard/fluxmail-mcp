---
title: 'List all mailbox account metadata'
description: 'Reference for GET /api/v1/admin/accounts.'
updated: '2026-07-15'
---
...
Reference for GET /api/v1/admin/accounts.
...
```bash
curl 'http://localhost:8977/api/v1/admin/accounts' \
